                      ...
                      <form method="POST" action="{{route('blog.store')}}" enctype="multipart/form-data" >
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <input type="text" name="title" value="{{ old('title') }}" class="form-control" id="basic-icon-default-fullname" placeholder="Post Title" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
                          </div>
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ old('thumbnail')}}" alt="Blog Thumbnail" class="d-block rounded" height="100" width="100" id="uploadedAvatar">
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    <span class="d-none d-sm-block">Upload Thumbnail</span>
                                    <i class="bx bx-upload d-block d-sm-none"></i>
                                    <input type="file" name="thumbnail" id="upload" class="account-file-input" hidden="" value="{{ old('thumbnail')}}" accept="image/png, image/jpeg">
                                </label>
