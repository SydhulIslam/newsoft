                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" value="{{ old('name') }}"
                                                class="form-control" id="basic-default-name" placeholder="Category Name" />
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="d-grid gap-2 col-6 mx-auto">
                                                        ...
                                                        <form method="post"
                                                                ...
                                                                <div class="modal-dialog modal-sm" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p> Assign new Category for Blogs of this
                                                                                Category </p>
                                                                            ...
                                                                            <hr>
                                                                            <p> Are You Sure, You Removed this Category !!
                                                                            </p>
                                                                            <hr>
                                                                        </div>
                                                            ...
                                                            <button type="button" class="btn btn-danger"
                                                                ...
                                                                data-bs-target="#smallModal{{ $category->id }}"> Remove
                                                            </button>
                                                        </form>
