...
<div class="section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="mb-5">
          <h2 class="mb-4" style="line-height:1.5">{{$blog_detail -> title}}</h2>
          <span>{{ date('d F', strtotime($blog_detail->created_at)) }} <span class="mx-2">/</span> </span>

          <p class="list-inline-item">Category : <a href="#!" class="ml-1">{{ $blog_detail->category->name}} </a></p>
          <p class="list-inline-item">Views : <a href="#!" class="ml-1">{{ $blog_detail->views}}  </a></p>
          <p class="list-inline-item">User : <a href="#!" class="ml-1">{{ $blog_detail->user->name}} </a></p>

        </div>
        <div class="mb-5 text-center">
          <div class="post-slider rounded overflow-hidden">
            <img loading="lazy" decoding="async" src="{{$blog_detail -> thumbnail}}" alt="Post Thumbnail">
          </div>
        </div>
        <div class="content">
          ...
          <p>
            <img loading="lazy" decoding="async" class="w-100 d-block mb-4" src="assets/images/blog/post-4.jpg"
